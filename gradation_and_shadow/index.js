...
function sphere(ctx) {
    ...
    const radialGradient = ctx.createRadialGradient(canvas.width / 2 - 60, canvas.height / 2 - 60, 25, canvas.width / 2 - 45, canvas.height / 2 - 45, 120);
